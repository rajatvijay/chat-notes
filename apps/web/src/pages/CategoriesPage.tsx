...
const categories = [
  {
    ...
    color:
      'bg-gradient-to-br from-rose-100 to-pink-100 text-rose-700 dark:from-rose-900/30 dark:to-pink-900/30 dark:text-rose-300',
  },
  {
    name: 'idea',
    label: 'Ideas',
    ...
    color:
      'bg-gradient-to-br from-amber-100 to-yellow-100 text-amber-700 dark:from-amber-900/30 dark:to-yellow-900/30 dark:text-amber-300',
  },
  {
    name: 'journal',
    label: 'Journal',
    ...
    color:
      'bg-gradient-to-br from-emerald-100 to-green-100 text-emerald-700 dark:from-emerald-900/30 dark:to-green-900/30 dark:text-emerald-300',
  },
  {
    name: 'meeting',
    label: 'Meetings',
    ...
    color:
      'bg-gradient-to-br from-blue-100 to-cyan-100 text-blue-700 dark:from-blue-900/30 dark:to-cyan-900/30 dark:text-blue-300',
  },
  {
    name: 'reading',
    label: 'Reading',
    ...
    color:
      'bg-gradient-to-br from-purple-100 to-violet-100 text-purple-700 dark:from-purple-900/30 dark:to-violet-900/30 dark:text-purple-300',
  },
  {
    name: 'misc',
    label: 'Misc',
    ...
    color:
      'bg-gradient-to-br from-slate-100 to-gray-100 text-slate-700 dark:from-slate-900/30 dark:to-gray-900/30 dark:text-slate-300',
  },
]
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div
          className={`w-12 h-12 rounded-2xl ${category.color} flex items-center justify-center shrink-0`}
        >
...
export default function CategoriesPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex flex-col">
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-lg bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-t border-white/20 dark:border-slate-800/50 z-40">
